...
export const CHAT_COLORS = [
  '#6366f1', '#10b981', '#f43f5e', '#f59e0b', '#8b5cf6', '#ec4899', '#06b6d4', '#ffffff'
];

// Strictly 24 hours as requested
export const EXPIRY_DURATION = 24 * 60 * 60 * 1000;
...
export const Icons = {
  ...
  Hammer: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L12 9"/></svg>
  ),
  Phone: () => (
