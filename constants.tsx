...
export const EXPIRY_DURATION = 60 * 60 * 1000;
...
export const Icons = {
  ...
  Sparkles: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"></path><path d="M19 3v4"></path><path d="M21 5h-4"></path></svg>
  ),
  Download: () => (
  ...
  Hammer: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L12 9"/><path d="M17.64 15 22 10.64"/><path d="m20.91 11.7-1.25-1.25c-.6-.6-.93-1.4-.93-2.25v-.86c0-1.02-.64-1.93-1.6-2.28A2.45 2.45 0 0 0 14 7.35v.86c0 .85-.33 1.65-.93 2.25l-1.25 1.25a2.12 2.12 0 0 0 0 3l1.25 1.25a2.12 2.12 0 0 0 3 0l1.25-1.25a2.12 2.12 0 0 0 0-3Z"/><path d="m15 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L12 9"/></svg>
  ),
  VolumeX: () => (
